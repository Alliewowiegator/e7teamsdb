          ...
          <Card>
            <CardContent>
              ...
              >
                <Grid2 item md={3} xs={4}>
                  <FormControl fullWidth>
                    ...
                    >
                      ...
                      <MenuItem value={"guildWarDefense"}>
                        Guild War Defense
                      </MenuItem>
                      <MenuItem value={"guildwarOffense"}>
                        Guild War Offense
                      </MenuItem>
                ...
                <Grid2 item md={1} mdOffset={2} xsOffset={1.7}>
                  <IconButton size="large" aria-label="delete" color="success">
                    <RefreshIcon />
                  </IconButton>
                </Grid2>
