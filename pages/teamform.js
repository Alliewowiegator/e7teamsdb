                                        ...
                                        <Grid2 item xs={4} md={12} sx={{paddingBottom: "1rem"}}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Select labelId="user-server" id="userServer" label="Server"
                                                            variant="standard"
                                        ...
                                        <Grid2 item xs={4} md={12}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <Select labelId="team-type" id="teamType" label="Team Type"
                                                            variant="standard"
                            ...
                            <Grid2 item xs={4} md={12}>
                                ...
                                >
                                    <Grid2 container columns={{xs: 4, sm: 8, md: 12}}>
                                        ...
                                        >
                                            <CompHeroCard heroInfo={initialHero[0]} openEditModal={openEditModal}
                                                          handleInputChange={handleInputChange}
                                            />
                                        </Grid2>
