              ...
              <Grid2 container spacing={2} columns={{ xs: 6, sm: 8, md: 4 }}>
                ...
                <Grid2 item md={1} xs={3}>
                  <TextField
                    ...
                    defaultValue={
                      props.heroInfo.criticalHitChance ? props.heroInfo.criticalHitChance : ""
                    }
                    fullWidth
                ...
                <Grid2 item md={1} xs={3}>
                  <TextField
                    ...
                    defaultValue={
                      props.heroInfo.criticalHitDamage ? props.heroInfo.criticalHitDamage : ""
                    }
                    fullWidth
                ...
                <Grid2 item md={1} xs={3}>
                  <TextField
                    name="effectiveness"
                    defaultValue={
                      props.heroInfo.effectiveness ? props.heroInfo.effectiveness : ""
                    }
                    fullWidth
                    label="Effectiveness"
                    variant="standard"
                ...
                <Grid2 item md={1} xs={3}>
                  <TextField
                    ...
                    defaultValue={
                      props.heroInfo.effectResistance ? props.heroInfo.effectResistance : ""
                    }
                    fullWidth
                ...
                <Grid2 item md={1} mdOffset={1} xs={3}>
                  <TextField
                    ...
                    defaultValue={
                      props.heroInfo.dualAttackChance ? props.heroInfo.dualAttackChance : ""
                    }
                    fullWidth
